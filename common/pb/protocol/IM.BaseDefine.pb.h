...
const ServiceID ServiceID_MAX = SID_CONSULT;
...
enum MessageCmdID {
  ...
  CID_GROUP_MEMBER_SHIELD_REQUEST = 793,
  CID_GROUP_MEMBER_REVOKE_REQUEST = 794,
...
const MessageCmdID MessageCmdID_MAX = CID_MSG_SINGLE_DATA_ACK;
...
const GroupCmdID GroupCmdID_MAX = CID_GROUP_DESCP_RESPONSE;
...
const OtherCmdID OtherCmdID_MAX = CID_OTHER_SET_DB_SERVER_CNT_RSP;
...
const ConsultCmdID ConsultCmdID_MAX = CID_CONSULT_DELIVER_ANNOUNCE;
...
enum MsgType {
  ...
  MSG_TYPE_MSG_REVOKE = 24,
  MSG_TYPE_MSG_SHIELD = 25
};
bool MsgType_IsValid(int value);
const MsgType MsgType_MIN = MSG_TYPE_SINGLE_TEXT;
const MsgType MsgType_MAX = MSG_TYPE_MSG_SHIELD;
...
const ClientIdentity ClientIdentity_MAX = CLIENT_IDENTITY_SYSTEM;
...
const ConsultCreateType ConsultCreateType_MAX = CONSULT_CREATE_TYPE_DUTY_DELIVER_TO_OFFLINE_MANAGER;
...
const ConsultCloseType ConsultCloseType_MAX = CONSULT_CLOSE_TYPE_STUDENT_CLOSE_INNER;
...
const ConsultScriptType ConsultScriptType_MAX = CONSULT_SCRIPT_TYPE_TEACHER_TO_APP;
