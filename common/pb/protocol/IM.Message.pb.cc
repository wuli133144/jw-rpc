...
const int IMMsgData::kRealNameFieldNumber;
const int IMMsgData::kMemDegreeFieldNumber;
const int IMMsgData::kPortTraitFieldNumber;
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[8 / 32] & 65280) {
    ...
    ZR_(single_chat_type_, mem_degree_);
    if (has_unique_key()) {
      if (unique_key_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
        unique_key_->clear();
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 14: {
        ...
        if (input->ExpectTag(122)) goto parse_real_name;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(128)) goto parse_mem_degree;
        break;
      }
      ...
      case 16: {
        ...
        if (input->ExpectTag(138)) goto parse_port_trait;
        break;
      }
...
void IMMsgData::SerializeWithCachedSizes(
  ...
  if (has_real_name()) {
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(
      15, this->real_name(), output);
  }

  // optional uint32 mem_degree = 16;
  if (has_mem_degree()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(16, this->mem_degree(), output);
  }

  // optional string port_trait = 17;
  if (has_port_trait()) {
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(
      17, this->port_trait(), output);
  }
...
void IMMsgData::MergeFrom(const IMMsgData& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_mem_degree()) {
      set_mem_degree(from.mem_degree());
    }
  }
  if (from._has_bits_[16 / 32] & (0xffu << (16 % 32))) {
    if (from.has_port_trait()) {
      set_port_trait(from.port_trait());
    }
...
void IMMsgData::Swap(IMMsgData* other) {
  if (other != this) {
    ...
    std::swap(mem_degree_, other->mem_degree_);
    std::swap(port_trait_, other->port_trait_);
